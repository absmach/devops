...
| auth.resources.limits.cpu | string | `"200m"` |  |
...
| journal.resources.limits.cpu | string | `"200m"` |  |
| journal.resources.limits.memory | string | `"256Mi"` |  |
| journal.resources.requests.cpu | string | `"100m"` |  |
| journal.resources.requests.memory | string | `"128Mi"` |  |
...
| redisclients.replica.resources.limits.cpu | string | `"500m"` |  |
| redisclients.replica.resources.limits.memory | string | `"512Mi"` |  |
| redisclients.replica.resources.requests.cpu | string | `"250m"` |  |
| redisclients.replica.resources.requests.memory | string | `"256Mi"` |  |
...
| redisdomains.master.resources.limits.cpu | string | `"200m"` |  |
| redisdomains.master.resources.limits.memory | string | `"256Mi"` |  |
| redisdomains.master.resources.requests.cpu | string | `"100m"` |  |
| redisdomains.master.resources.requests.memory | string | `"128Mi"` |  |
...
| users.resources.limits.cpu | string | `"200m"` |  |
| users.resources.limits.memory | string | `"256Mi"` |  |
| users.resources.requests.cpu | string | `"100m"` |  |
| users.resources.requests.memory | string | `"128Mi"` |  |
